...
def open_book(book_id, file_type, start_page):
...
#book_id is the database id of the book, page_index is the page number (or other identifier depending on file type)
